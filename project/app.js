...
window.addEventListener('scroll', function() {
  ...
  if (window.scrollY > 0) {
   ...
   function hideAllProductCategories() {
            const productCategories = document.querySelectorAll('.perfumes, .skincare1, .makeup');
        ...
        function togglePerfumes() {
            ...
            perfumes.style.display = "block";
            perfumes.classList.add('show');
        }

        function skincare() {
            hideAllProductCategories();
            const skincare = document.querySelector('.skincare1');
            skincare.style.display = "block";
            skincare.classList.add('show1');
        }
